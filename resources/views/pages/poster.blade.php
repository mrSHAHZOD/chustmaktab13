                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12 col-sm-10">
                                <div class="blog blog-s2 animated" data-animate="fadeInUp" data-delay=".2">
                                    ...
                                    <div class="blog-text">
                                        <ul class="blog-meta">
                                            <li><a href="#">{{ $poster->number }} -
                                                    {{ $poster['month_' . \App::getLocale()] }}</a></li>
                                        </ul>
                                        <h4 class="title title-sm"><a
                                                href="#">{{ $poster['title_' . \App::getLocale()] }}</a>
                                        </h4>
                                        <p>{!! $poster['body_' . \App::getLocale()] !!}
                                        </p>
                                        <div class="btn-group" role="group" aria-label="Basic example">

                                            <button type="button" class="btn btn-primary"><a class="create__btn"
                                                    href="/home"> <i class='bx bx-arrow-back'></i>Qaytish</a>
                                            </button>
                                        </div>
                                    </div>
                                </div><!-- .blog -->
