...
<head>
    ...
    <!-- Fav Icon  -->
    <link rel="shortcut icon" href="/images/13newlogo.jpg">
    <!-- Site Title  -->
                    ...
                    <div class="header-wrap">
                        ...
                        <div class="header-logo logo animated" data-animate="fadeInDown" data-delay=".65">
                            <a href="/" class="logo-link">
                                <img class="logo-dark" src="/images/13new2kogo.jpg" alt="logo">
                                <img class="logo-light" src="/images/13newlogo.jpg" alt="logo">
                        ...
                        <div class="nk-block nk-block-footer">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-5">
                                    <div class="wgs wgs-menu">
                                        ...
                                        <div class="contact-text">
                                           ...
                                           <span><a href="#">+998 (91)-341-42-82</a></span><br>
                                           <span><a href="#">+998 (91)-341-42-82</a></span><br>
                                           <span><a href="#"> +998 (91)-341-42-82</a></span>
                                       </div>
                                    </div>
                                </div><!-- .col -->
                            ...
                            <div class="footer-bottom pdt-r">
                                <div class="copyright-text copyright-text-s3 text-center">
                                    <p>© 2024 CHUST 13-School website Made by <a href="#">TECHDATA.</a> <a href="./">Privacy policy</a></p>
                                </div>
                            </div>
                        </div><!-- .block @e -->
                    </div>
